...
void loadConfig() {
	...
	if (!runtimeDirectory.empty())
	{
		...
		for (auto& it : configMap)
		{
			...
			config[it.second]["linearXspreadforceYRot"] = 0.0f;
			config[it.second]["linearXspreadforceZRot"] = 0.0f;
			config[it.second]["linearYspreadforceXRot"] = 0.0f;
			config[it.second]["linearYspreadforceZRot"] = 0.0f;
			config[it.second]["linearZspreadforceXRot"] = 0.0f;
			config[it.second]["linearZspreadforceYRot"] = 0.0f;
			...
			config0weight[it.second]["linearXspreadforceYRot"] = 0.0f;
			config0weight[it.second]["linearXspreadforceZRot"] = 0.0f;
			config0weight[it.second]["linearYspreadforceXRot"] = 0.0f;
			config0weight[it.second]["linearYspreadforceZRot"] = 0.0f;
			config0weight[it.second]["linearZspreadforceXRot"] = 0.0f;
			config0weight[it.second]["linearZspreadforceYRot"] = 0.0f;
								...
								if (variableName == "Conditions")
								{
									...
									if (withConditions)
									{
										...
										for (auto& it : configMap)
										{
											...
											newNPCBounceConfig.config[it.second]["linearXspreadforceYRot"] = 0.0f;
											newNPCBounceConfig.config[it.second]["linearXspreadforceZRot"] = 0.0f;
											newNPCBounceConfig.config[it.second]["linearYspreadforceXRot"] = 0.0f;
											newNPCBounceConfig.config[it.second]["linearYspreadforceZRot"] = 0.0f;
											newNPCBounceConfig.config[it.second]["linearZspreadforceXRot"] = 0.0f;
											newNPCBounceConfig.config[it.second]["linearZspreadforceYRot"] = 0.0f;
											...
											newNPCBounceConfig.config0weight[it.second]["linearXspreadforceYRot"] = 0.0f;
											newNPCBounceConfig.config0weight[it.second]["linearXspreadforceZRot"] = 0.0f;
											newNPCBounceConfig.config0weight[it.second]["linearYspreadforceXRot"] = 0.0f;
											newNPCBounceConfig.config0weight[it.second]["linearYspreadforceZRot"] = 0.0f;
											newNPCBounceConfig.config0weight[it.second]["linearZspreadforceXRot"] = 0.0f;
											newNPCBounceConfig.config0weight[it.second]["linearZspreadforceYRot"] = 0.0f;
